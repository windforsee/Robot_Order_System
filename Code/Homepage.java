...
public class Homepage extends RobotGUI {
 ...
 */
	...
	public void buildHome(){
		...
		please.setFont(new Font("Microsoft YaHei UI", Font.BOLD, 39));
		//make the top word bigger
		...
		option.setFont(new Font("Microsoft YaHei UI", Font.BOLD, 39));
	...
	class getnum implements ActionListener{
		public void actionPerformed(ActionEvent event){
			...
			if(choose.equals("1")||choose.equals("2")||choose.equals("3")||choose.equals("4")||choose.equals("5")){
				int choiceF = Integer.parseInt(choose);
				option.setVisible(false);
				menulist.setVisible(false);
				please.setVisible(false);
				DishesCreater choiceFMenu = new DishesCreater(frame,choiceF);
				choiceFMenu.buildDishesGUI();
			}else{
				please.setVisible(false);
	...
	//get users input to determined which next menu will enter
